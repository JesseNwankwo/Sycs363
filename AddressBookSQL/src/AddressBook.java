...
public class AddressBook implements ActionListener
{
	...
	Contact personObj;
   	...
   	String phone;
   	int recordNumber;	 // used to navigate using >> and << buttons 
   	Container cPane;
   ...
   { 	
	    ...
	    // creating Contact Data Access Object
	    personObj = new Contact();	
   	...
   	public void createGUI(){
   		...
   		//Arrange components on content-Pane and set Action Listeners to each JButton
   		arrangeComponents();
     ...
     public void savePerson(){  
	   	...
	   	name = name.toUpperCase();	//Save all names in Upper case
	   	...
	   	if(name.equals("")){
	   		JOptionPane.showMessageDialog(null, "Please enter person name.");
		   	  ...
		   	  //create a PersonInfo object and pass it to Contact to save it
		   	  PersonInfo person = new PersonInfo(name, address, phone, email);
		   	personObj.savePerson(person);
     ...
     public void deletePerson(){
	   	...
	   	if(name.equals("")){
	   		...
	   		int numberOfDeleted = personObj.removePerson(name);
    ...
    public void updatePerson(){
       ...
       email   = jtfEmail.getText();
   	   ...
   	   person = new PersonInfo(name, address, phone, email);
    ...
    //Perform a Case-Insensitive Search to find the Person
      ...
      public void searchPerson() {
	   	...
	   	if(name.equals("")){
	   		...
	   		personsList = personObj.searchPerson(name);
   ...
   public void displayNextRecord(){
    ...
    // increase in recordNumber to display next person info, already stored in 
	//  personsList during search                  
       ...
       // decrease by one to counter last increase
       recordNumber -- ; 
   	}
   	else{
   		jbnBack.setEnabled(true);
     ...
     public void displayPreviousRecord(){
         ...
         // decrease in recordNumber to display previous person info, already 
    	 //stored in personsList during search                  
	   	recordNumber--;
	
	   	if(recordNumber < 0 ){
	        JOptionPane.showMessageDialog(null, "You have reached beginning " +
	        		"of search results"); 
	
	   		/*if user has reached the beginning of results, disable back button*/
	   		jbnForward.setEnabled(true);
	   		jbnBack.setEnabled(false);
	
             // increase by one to counter last decrease
               recordNumber++;
	   	}else{
	   		jbnForward.setEnabled(true);
	   		PersonInfo person = (PersonInfo) personsList.get(recordNumber);
